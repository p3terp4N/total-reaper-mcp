...
from .tools.production_workflow import register_production_workflow_tools
from .tools.render_export import register_render_export_tools
from .tools.midi_production import register_midi_production_tools
from .tools.arrangement import register_arrangement_tools
...
CATEGORY_REGISTRY = {
    ...
    "Production Workflow": register_production_workflow_tools,
    "Render & Export": register_render_export_tools,
    "MIDI Production": register_midi_production_tools,
    "Arrangement": register_arrangement_tools,
}
